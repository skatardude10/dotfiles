...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = KEYMAP(
    ...
    TD(2),    XXXXXXX,  KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     F(4),
    CTL_T(KC_Z), GUI_T(KC_X), ALT_T(KC_C), F(0), F(1), F(2),    F(3),     KC_M,     KC_S,    TD(1))
  ,
  [_ZERO] = KEYMAP(
  ...
  ,
  [_ONE] = KEYMAP(
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_DEL,  KC_BSPC,
    KC_RSFT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_QUOT,  KC_GRV,   KC_SCLN,  KC_MINS,  KC_EQL,
    _______,  _______,  _______,  XXXXXXX,  _______,  KC_SLSH,  KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_RSFT)
  ,
  [_TWO] = KEYMAP(
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PGDOWN,  KC_UP,  KC_PGUP,  KC_BSPC,
    KC_CAPS,  XXXXXXX,  _______,  XXXXXXX,  XXXXXXX,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  KC_PSCREEN,
    _______,  _______,  _______,  XXXXXXX,  RALT(KC_GRAVE),  _______,  KC_END,  XXXXXXX,  XXXXXXX,  _______)
  ,
  [_ADJUST] = KEYMAP(
    RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  XXXXXXX,  KC_WH_D,  KC_MS_U,  KC_WH_U,  KC_PAUS,
    XXXXXXX,  XXXXXXX,  RGB_VAD,  RGB_HUD,  RGB_SAD,  XXXXXXX,  KC_MS_L,  KC_MS_D,  KC_MS_R,  KC_BTN3,
    TG(_TOGGLE),   _______,  _______,  XXXXXXX,  KC_BTN1,  KC_BTN2,  _______,  XXXXXXX,  XXXXXXX,  _______)
  ,
  [_WINMAN] = KEYMAP(
    M_KILL,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  M_WINU,   M_GDEC,   M_GINC,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  M_FULS,   M_VERT,   M_HORZ,   M_WINL,   M_WIND,   M_WINR,   _______,
    XXXXXXX,  XXXXXXX,  M_NET,    M_MWSL,   M_GWSL,   M_GWSR,   M_MWSR,   XXXXXXX,  XXXXXXX,  _______)
  ,
  [_TOGGLE] = KEYMAP(
    KC_NLCK,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PAST,  KC_P7,  KC_P8,  KC_P9,  KC_PMNS,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PSLS,  KC_P4,  KC_P5,  KC_P6,  KC_PPLS,
    TO(_QWERTY),   XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PDOT,  KC_P0,  KC_P1,  KC_P2,  KC_P3,  KC_PENT)
}; 
