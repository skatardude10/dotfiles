...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = KEYMAP( \
        ...
        KC_TAB,  KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    F(2),\
        KC_LSFT, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_RSFT,\
        KC_LCTL, KC_LALT, KC_LGUI,     F(0),      F(1),     ADJUST, RALT(KC_GRAVE), KC_RCTL \
		),
    ...
    [_ADJUST] = KEYMAP( \
		...
		TG(_GAMING), _______, _______, KC_BTN1, KC_BTN2, _______, BL_TOGG, BL_DEC \
		),
    ...
    KC_LSFT, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_RSFT,\
    KC_LCTL, KC_LALT, KC_LGUI,     KC_SPC,      GAMEXTRA,     TO(_QWERTY), RALT(KC_GRAVE), KC_RCTL \
    ),

    [_GAMEXTRA] = KEYMAP( \
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, \
    KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, \
    _______, _______, _______, _______, _______, KC_QUOTE, KC_SLASH, KC_LBRACKET, KC_RBRACKET, KC_BSLASH, KC_EQUAL, \
    _______, _______, _______, _______, _______, _______, _______, _______ \
    ),
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [2]  = ACTION_LAYER_TAP_KEY(_WINMAN, KC_ENT),
  [3]  = ACTION_LAYER_TAP_KEY(_GAMEXTRA, KC_SPC),
};
